...
const awsccCodestarconnectionsConnection = `{
  "block": {
    "attributes": {
      "connection_arn": {
        "computed": true,
...
func AwsccCodestarconnectionsConnectionSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(awsccCodestarconnectionsConnection), &result)
	return &result
}
