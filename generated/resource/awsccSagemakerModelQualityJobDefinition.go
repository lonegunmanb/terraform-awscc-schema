...
const awsccSagemakerModelQualityJobDefinition = `{
  "block": {
    "attributes": {
      "creation_time": {
        "computed": true,
...
func AwsccSagemakerModelQualityJobDefinitionSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(awsccSagemakerModelQualityJobDefinition), &result)
	return &result
}
