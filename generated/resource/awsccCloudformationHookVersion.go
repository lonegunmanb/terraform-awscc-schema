...
const awsccCloudformationHookVersion = `{
  "block": {
    "attributes": {
      "arn": {
        "computed": true,
...
func AwsccCloudformationHookVersionSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(awsccCloudformationHookVersion), &result)
	return &result
}
