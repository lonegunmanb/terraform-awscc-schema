...
const awsccSagemakerModelBiasJobDefinition = `{
  "block": {
    "attributes": {
      "creation_time": {
        "computed": true,
...
func AwsccSagemakerModelBiasJobDefinitionSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(awsccSagemakerModelBiasJobDefinition), &result)
	return &result
}
