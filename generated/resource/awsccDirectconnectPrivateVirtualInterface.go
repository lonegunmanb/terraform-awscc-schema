...
const awsccDirectconnectPrivateVirtualInterface = `{
  "block": {
    "attributes": {
...
func AwsccDirectconnectPrivateVirtualInterfaceSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(awsccDirectconnectPrivateVirtualInterface), &result)
	return &result
}
